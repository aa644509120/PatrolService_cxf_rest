 ...
 */
@EntityDesc(name="YQ信息",tableName="YINFO")
public class Yinfo implements java.io.Serializable {
	...
	@Description(name="链接地址",columnName="url")
	private String url;
	@Description(name="信息类别",columnName="type")
	private String type;
	...
	@Description(name="信息源头",columnName="origin")
	...
	/** full constructor */
	public Yinfo(String title, String content, String url, String type,
			Date publishtime, String attachmentsid, Date savetime,
			Integer status, String origin, Long suser, Integer iscommit,
			String codeKey,String codeType,String susername,Date committime) {
		this.title = title;
